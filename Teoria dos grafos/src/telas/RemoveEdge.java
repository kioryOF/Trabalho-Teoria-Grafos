...
public class RemoveEdge extends javax.swing.JFrame {
    ...
    private String[] arrayDeAresta;

    public RemoveEdge() {
        arrayDeAresta = atualizaArray();
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Escolha a aresta:");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(arrayDeAresta));
        ...
        jButton2.setText("Deletar aresta");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RemoveEdge().setVisible(true);
            }
        });
    }
